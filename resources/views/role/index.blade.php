    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="d-flex flex-row-reverse">
          <a href="{{route('cms.role.create')}}"><div class="p-2 mb-3 bg-success text-dark shadow-sm rounded" style="cursor: pointer;"> Add New Role &nbsp; <i class="fa fa-plus" aria-hidden="true"></i>
          </div></a>
      </div>
      @endcan
        ...
        <table class="table">
            <thead class="thead-dark">
              <tr>
                ...
                @canany(['update', 'delete'], \App\Models\role::class)
            ...
            <tbody>
              ...
              <tr id="roleRow_{{ $roles->id }}">
                ...
                <td class="d-flex justify-center " style="align-items: center; gap:8px;">
                  ...
                  <a href="{{route('cms.role.edit',$roles->id)}}"><span class="p-2 mb-3 bg-primary text-dark shadow-sm rounded" style="cursor: pointer;"> Edit &nbsp; <i class="fas fa-edit"></i></span></a>
                  @endcan
...
<script>
  function confirmDelete(roleId) {
      ...
      if (confirmation) {
          axios.delete('{{ route("cms.role.destroy", ["id" => "roleId"]) }}'.replace('roleId', roleId))
              .then(response => {
                showDeleteAlert("data deleted successfully", 'alert-success');
                $("#roleRow_" + roleId).remove();
              })
              .catch(error => {
                showDeleteAlert("data delete unsuccessful", 'alert-danger');
              });
      }
